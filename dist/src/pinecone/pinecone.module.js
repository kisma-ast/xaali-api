...
exports.PineconeModule = PineconeModule = __decorate([
    (0, common_1.Module)({
        providers: [pinecone_service_1.PineconeService, embedding_service_1.EmbeddingService],
        exports: [pinecone_service_1.PineconeService, embedding_service_1.EmbeddingService],
    })
], PineconeModule);
