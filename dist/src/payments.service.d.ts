...
export declare class PaymentsService {
    ...
    constructor(paymentsRepository: Repository<Payment>, bictorysService: BictorysService, payTechService: PayTechService);
    ...
    createFromPayTech(paytechResponse: any, userId?: number): Promise<Payment>;
    updateFromPayTechStatus(paymentStatus: PayTechPaymentStatus): Promise<Payment | null>;
}
